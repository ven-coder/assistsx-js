...
# AssistsX JS运行平台
开发的自动化脚本需要运行在Android端[AssistsX](https://github.com/ven-coder/assistsx)中，所以开发前需要先在手机安装[AssistsX](https://github.com/ven-coder/assistsx)
...
## 4. 加载插件
1. 通过[AssistsX](https://github.com/ven-coder/assistsx)局域网加载插件
